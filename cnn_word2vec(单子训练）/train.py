...
tf.flags.DEFINE_string("positive_data_file", "./data/pos.utf8", "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file", "./data/neg.utf8", "Data source for the negative data.")
